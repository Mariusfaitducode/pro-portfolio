...
export const PROJECTS = [
  {
    ...
    tech: ["NextJs", "TypeScript", "Tailwind CSS", "Supabase", "Stripe", "Gmail API", "AI integration"],
  ...
  },
  {
    ...
    tech: ["React", "TypeScript", "Tailwind CSS", "Three.js", "Supabase", "Stripe"],
...
export const CAREER_TIMELINE = [
  {
    ...
    company: "Spore.Bio",
    description: "Deeptech reinventing microbiological testing. Developing scalable and efficient software architecture.",
  ...
  },
  {
    ...
    company: "ULiège",
    description: "Specialized block semester focusing on AI fundamentals, computer vision and deep learning.",
  ...
  },
  {
    ...
    company: "UTBM",
    description: "Specialized block semester focusing on virtual environments, 3D modeling and game development.",
    logo: "/images/career/utbm.webp",
    url: "https://www.utbm.fr",
  },
  {
...
export const SKILL_CATEGORIES = [
  {
    ...
    items: [
      ...
      { name: "C", logo: "/images/skills/programming/c.svg", url: "https://en.wikipedia.org/wiki/C_(programming_language)" },
      ...
      { name: "C++", logo: "/images/skills/programming/cpp.svg", url: "https://en.wikipedia.org/wiki/C%2B%2B" },
  ...
  },
  {
    title: "Databases",
    items: [
      { name: "SQL", logo: "/images/skills/databases/sql.svg", url: "https://fr.wikipedia.org/wiki/Structured_Query_Language" },
